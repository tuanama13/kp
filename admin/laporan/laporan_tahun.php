	        ...
	        <div class="col-md-12">
	          <div class="box box-info">
	            <div class="box-header">
	              <h3 class="box-title">Laporan Pendapatan
	                <small>Untuk Melihat Pendaptan</small>
	              </h3>
	            </div>
	            <!-- /.box-header -->
                      ...
                      <div class="box-body">
                           <div class="form-group">
                            ...
                            <?php  
                              ...
                              $sql = "SELECT YEAR(tgl_transaksi) AS tahun FROM transaksi GROUP BY  YEAR(tgl_transaksi) ASC";
                          ...
                          <div class="form-group">
                            ...
                            <?php  
                              $sql = "SELECT MONTHNAME(tgl_transaksi) AS Bulan, MONTH(tgl_transaksi) AS bulan FROM transaksi WHERE grand_total > 0 GROUP BY  MONTH(tgl_transaksi) ASC";
                              $run_sql = mysqli_query($conn,$sql);
                               while($rows = mysqli_fetch_array($run_sql)){
                ...
                <div class="col-md-6">
                  <div class="box box-solid">
                    ...
                    <!-- /.box-header -->
                      <div class="box-body">
                        <h2>Pendapatan Total Tahun : <?php echo date("Y"); ?></h2>
                        <?php 
                          $tahun_ini= date('Y');
                          $sql = "SELECT SUM(grand_total) AS laba FROM transaksi WHERE YEAR(tgl_transaksi) = '$tahun_ini'";
                          $run_sql = mysqli_query($conn,$sql);
