  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-tags"></i> <span>Kategori</span></a></li>
        <!-- <li><a href="barang.php"><i class="fa fa-tags"></i> <span>Barang</span></a></li> -->
        <li class="treeview">
          <a href="#"><i class="fa fa-file-o"></i> <span>  Karyawan</span>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-file-o"></i> <span>  Barang</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-file-o"></i> <span>  Toko</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-file-o"></i> <span> User</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="new_user.php" > <i class="fa fa-plus"></i>Tambah User</a></li>
            <li><a href="list_user.php"><i class="fa fa-list"></i>List User</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
